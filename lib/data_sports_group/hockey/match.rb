...
module DataSportsGroup
  module Hockey
    class Match < Struct.new(:match_id, :date, :time, :date_utc, :time_utc, :team_a_id, :team_a_current_name, :team_a_short_name, :team_a_tla_name, :team_a_original_name, :team_a_country, :team_b_id, :team_b_current_name, :team_b_short_name, :team_b_tla_name, :team_b_original_name, :team_b_country, :status, :gameweek, :winner, :score_a, :score_b, :score_p1s_a, :score_p1s_b, :score_p2s_a, :score_p2s_b, :score_p3s_a, :score_p3s_b, :score_ot_a, :score_ot_b, :score_so_a, :score_so_b, :score_venue_type, :game_minute, :final_period, :attendance, :venue_id, :venue_name, :venue_city, :last_updated, :final)
