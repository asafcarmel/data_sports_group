...
describe DataSportsGroup::Football::FootballApi, vcr: {
  ...
  context 'API integration' do
    ...
    describe '.get_season_matches' do
      let(:sample_match) { DataSportsGroup::Football::Match.new('521502', DateTime.new(2015,8,14,20,30), '20:30:00', DateTime.new(2015,8,14,18,30), '18:30:00', '539', 'FC Bayern München', 'Bayern M', 'BAY', '', 'DEU', '524', 'Hamburger SV', 'HSV', 'HSV', '', 'DEU', 'Played', '1', 'team_A',  '5', '0', '1', '0', '4', '0', '', '', '', '', 'home_away', '', 'soc_p2s', 75000, '290', 'Allianz-Arena', 'München', DateTime.new(2015,10,15,13,30,43)) }
    ...
    describe '.get_detailed_match' do
      let(:sample_score) { DataSportsGroup::Football::Score.new('11538', 'Serge', 'Aurier', 'S. Aurier', 'Côte d’Ivoire', 'Defender', '19', '574', 'Paris Saint-Germain FC', 0, 0, 0, 1, 1, 3, 0, 2, 0, 1, 1, 0, 0, 0, 0, 1, 0, 0, 90, 1, 0)}
      let(:sample_match) { DataSportsGroup::Football::Match.new('542466', DateTime.new(2015,9,30,20,45), '20:45:00', DateTime.new(2015,9,30,18,45), '18:45:00', '865', 'FK Shakhtar Donetsk', 'Shak Donetsk', 'SHD', 'FK Shakhtar Donetsk', 'UKR', '574', 'Paris Saint-Germain FC', 'PSG', 'PSG', 'Paris Saint-Germain FC', 'FRA', 'Played', '2', 'team_B',  '0', '3', '0', '2', '0', '1', '', '', '', '', 'home_away', '', 'soc_p2s', 32730, '836', 'L\'viv Arena', 'Lviv', DateTime.new(2015,10,14,22,6,25)) }
